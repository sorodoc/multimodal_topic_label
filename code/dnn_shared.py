...
import multimodal_model_shared
import shelve
...
#    p_t_inp = calc_page_rank(w_t_inf)
    ...
    m = multimodal_model_shared.TNN()
    model1, model2 = m.buildModels()
...
#    model2.fit([w_tr_inp, p_tr_inp], [w_tr_l], nb_epoch = nb_epoch, batch_size = batch_size, validation_split = 0.1)
